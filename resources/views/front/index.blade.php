...
<head>
    ...
    <link href="{{ asset('front/css/font-awesome/css/all.min.css?ver=1.2.0') }}" rel="stylesheet">
    <link href="{{ asset('front/css/bootstrap-icons/bootstrap-icons.css?ver=1.2.0') }}" rel="stylesheet">
    <link href="{{ asset('front/css/bootstrap.min.css?ver=1.2.0') }}" rel="stylesheet">
    <link href="{{ asset('front/css/aos.css?ver=1.2.0') }}" rel="stylesheet">
...
<body id="top">
                    ...
                    <div class="container px-3">
                        <div class="row">
                            <div class="col-lg-6 p-2"><img class="img-fluid"
                                    src="{{ asset('front/images/illustrations/hello3.svg') }}" alt="hello" /></div>
                            <div class="col-lg-6">
                                <div class="mt-5">
                                    <p class="lead text-uppercase mb-1">Hello!</p>
                                    <h1 class="intro-title marker" data-aos="fade-left" data-aos-delay="50">I’m Walter
                                        Patterson</h1>
                ...
                <div class="container-narrow">
                    <div class="row">
                        ...
                        <div class="col-md-5 offset-md-1" data-aos="fade-left" data-aos-delay="100"><img
                                class="avatar img-fluid mt-2" src="{{ asset('front/images/avatar.jpg') }}"
                ...
                <div class="container-narrow">
                    ...
                    <div class="row py-3">
                        <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="100"><img
                                class="mb-2" src="{{ asset('front/images/services/web-design.svg') }}"
                        ...
                        <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="200"><img
                                class="mb-2" src="{{ asset('front/images/services/graphic-design.svg') }}"
                        ...
                        <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="300"><img
                                class="mb-2" src="{{ asset('front/images/services/ui-ux.svg') }}" width="96"
                                height="96" alt="ui-ux" />
                            <div class="h5">UI/UX</div>
                        </div>
                        <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="400"><img
                                class="mb-2" src="{{ asset('front/images/services/app-development.svg') }}"
                    ...
                    <div class="grid bp-gallery pb-3" data-aos="zoom-in-up" data-aos-delay="100">
                        ...
                        <div class="grid-item"><a href="https://dribbble.com">
                                <figure class="portfolio-item"><img
                                        src="{{ asset('front/images/portfolio/1-small.png') }}"
                                        data-bp="{{ asset('front/images/portfolio/1.jpg') }}" />
                                    <figcaption>
                        ...
                        <div class="grid-item"><a href="https://github.com">
                                <figure class="portfolio-item"><img
                                        src="{{ asset('front/images/portfolio/2-small.png') }}"
                                        data-bp="{{ asset('front/images/portfolio/2.jpg') }}"
                        ...
                        <div class="grid-item"><a href="https://soundcloud.com/">
                                <figure class="portfolio-item"><img
                                        src="{{ asset('front/images/portfolio/3-small.png') }}"
                                        data-bp="{{ asset('front/images/portfolio/3.jpg') }}"
                                        data-caption="Example of an optional caption." />
                                    <figcaption>
                        ...
                        <div class="grid-item"><a href="https://www.adobe.com/">
                                <figure class="portfolio-item"><img
                                        src="{{ asset('front/images/portfolio/4-small.png') }}"
                                        data-bp="{{ asset('front/images/portfolio/4.jpg') }}" />
                                    <figcaption>
                        ...
                        <div class="grid-item"><a href="https://www.adobe.com/">
                                <figure class="portfolio-item"><img
                                        src="{{ asset('front/images/portfolio/5-small.png') }}"
                                        data-bp="{{ asset('front/images/portfolio/5.jpg') }}" />
                                    <figcaption>
                        ...
                        <div class="grid-item"><a href="https://www.android.com/">
                                <figure class="portfolio-item"><img
                                        src="{{ asset('front/images/portfolio/6-small.png') }}"
                                        data-bp="{{ asset('front/images/portfolio/6.jpg') }}" />
                                    <figcaption>
                        ...
                        <div class="grid-item"><a href="https://flutter.dev/">
                                <figure class="portfolio-item"><img
                                        src="{{ asset('front/images/portfolio/7-small.png') }}"
                                        data-bp="{{ asset('front/images/portfolio/7.jpg') }}" />
                                    <figcaption>
                        ...
                        <div class="grid-item"><a href="https://flutter.dev/">
                                <figure class="portfolio-item"><img
                                        src="{{ asset('front/images/portfolio/8-small.png') }}"
                                        data-bp="{{ asset('front/images/portfolio/8.jpg') }}" />
                                    <figcaption>
                                        <h4 class="h5 mb-0">App Development</h4>
                                        <div>Flutter</div>
                                    </figcaption>
                            ...
                            <div class="card mb-3" data-aos="fade-right" data-aos-delay="100">
                                <div class="card-header px-3 py-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        </div><img src="{{ asset('front/images/services/ui-ux.svg') }}"
                            ...
                            <div class="card mb-3" data-aos="fade-left" data-aos-delay="300">
                                <div class="card-header px-3 py-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        </div><img src="{{ asset('front/images/services/app-development.svg') }}"
                            ...
                            <div class="card mb-3" data-aos="fade-right" data-aos-delay="200">
                                <div class="card-header px-3 py-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        </div><img src="{{ asset('front/images/services/web-design.svg') }}"
                            ...
                            <div class="card mb-3" data-aos="fade-left" data-aos-delay="400">
                                <div class="card-header px-3 py-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        </div><img src="{{ asset('front/images/services/full-stack.svg') }}"
                        ...
                        <div class="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="100">
                            ...
                            <div class="d-flex justify-content-end align-items-end">
                                <div class="text-end me-2">
                                    ...
                                    src="{{ asset('front/images/testimonials/client1.jpg') }}" width="96"
                        ...
                        <div class="col-md-6 mb-5" data-aos="fade-left" data-aos-delay="300">
                            ...
                            <div class="d-flex justify-content-end align-items-end">
                                <div class="text-end me-2">
                                    ...
                                    src="{{ asset('front/images/testimonials/client2.jpg') }}" width="96"
                                    height="96" alt="client 1" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="200">
                            ...
                            <div class="d-flex justify-content-end align-items-end">
                                <div class="text-end me-2">
                                    ...
                                    src="{{ asset('front/images/testimonials/client3.jpg') }}" width="96"
                                    height="96" alt="client 1" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-5" data-aos="fade-left" data-aos-delay="400">
                            ...
                            <div class="d-flex justify-content-end align-items-end">
                                <div class="text-end me-2">
                                    ...
                                    src="{{ asset('front/images/testimonials/client4.jpg') }}" width="96"
                                    height="96" alt="client 1" />
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset('front/scripts/imagesloaded.pkgd.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('front/scripts/masonry.pkgd.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('front/scripts/BigPicture.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('front/scripts/purecounter.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('front/scripts/bootstrap.bundle.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('front/scripts/aos.min.js?ver=1.2.0') }}"></script>
